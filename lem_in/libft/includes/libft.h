...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/05 12:51:13 by jjaegle           #+#    #+#             */
/*   Updated: 2019/10/09 12:24:31 by jjaegle          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list				*ft_lstmergesort(t_list *list, int (*f)(void*, void*));
void				ft_lstrev(t_list **al);
int					get_next_line(int fd, char **line, int opt);
